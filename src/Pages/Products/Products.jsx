...
function Products() {
  ...
  useEffect(() => {
    http
      .get(`products/list/admin?limit=15&page=1`, {
        headers: {
          token: token,
    ...
    <div>
      {productsList.isFetched ? (
        <div className="container">
              ...
              <tbody>
                {productsList.data?.map((product, index) => (
                  <tr key={index} className="table_tr">
                    ...
                    <td>
                      {truncateTextAfterWords(product.product_description_uz)}
                    </td>
                    ...
                    <td className="btns">
                      <button
                        ...
                        onClick={() => {
                          ...
                          setDefaultTitleUz(product.product_name_uz);
                          setDefaultTitleRu(product.product_name_ru);
                          setDefaultDescUz(product.product_description_uz);
                          setDefaultDescRu(product.product_description_ru);
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          setInfoDescUz(product.product_description_uz);
                          setInfoDescRu(product.product_description_ru);
          ...
          <Pagination page={page} setPage={setPage} data={productsList.data} />
        </div>
      ) : (
